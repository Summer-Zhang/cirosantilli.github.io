...
Old cheat at: link:web/[]

Now moving to either:

* files under: link:web-cheat/[] for the boring stuff
...
** link:web-cheat/js-image-load.html[]: load an image from JavaScript dynamically when it would become visible on the viewport: https://stackoverflow.com/questions/2321907/how-do-you-make-images-load-only-when-they-are-in-the-viewport
